...
**WebMarker** is a JavaScript library used for adding visual markers and labels to elements on a web page. This can be used for [Set-of-Mark](https://github.com/microsoft/SoM) prompting, which improves visual grounding abilities of vision-language models. This library aims to:
